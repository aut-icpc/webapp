...
@section('content')
    <form name="online_register" class="col s12 m12 l12" action="{{ route('app::apl.register.submit') }}" method="POST">
        {{ csrf_field() }}
        <div id="non-skrollr">
            <div class="row">
                <h3><br>Amirkabir Programming League Registration<br></h3>
                <h5>4th Amirkabir Programming League - Spring 2017</h5>
                <p>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 m3 l3">
                            <input id="mem1-email" name="members[first][email]" type="text" class="validate">
                        ...
                        <div class="input-field col s12 m12 l12 center">
                            ...
                            <label for="mem1-agreement" id="mem1-agreement-label">I have read and accept
                                {{--<a style="color: #00b0ff;" href="{{ route('app::general.rules') }}">Regional Rules</a> and--}}
                                <a style="color: #00b0ff;" href="{{ route('app::local.rules') }}">Local Rules</a>.</label>
                        </div>
                    </div>
                    <!-- /Member 1 Info -->
