...
@section('content')
    <div id="non-skrollr">
        ...
        <div class="row">
            <h3><br>Contest Registration<br></h3>
            <p>
                16th Amirkabir Collegiate Programming Contest - 21 Nov 2016
            </p>
            <div class="container-fluid">
                <form class="col s12 m12 l12">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s3 m3 l3">
                            <input id="mem1-email" name="members[first][email]" data-error="Wrong Mail Format" data-success="Correct Mail Format" type="email" class="validate">
                        ...
                        <div class="input-field col s12 m12 l12 center">
                            ...
                            <label for="mem1-agreement">I have read and accept <a href="{{ route('app::general.rules') }}">Regional Rules</a> and <a href="{{ route('app::local.rules') }}">Local Rules</a>.</label>
                        </div>
                    </div>
                    <!-- /Member 1 Info -->
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m12 l12 center">
                            ...
                            <label for="mem2-agreement">I have read and accept <a href="{{ route('app::general.rules') }}">Regional Rules</a> and <a href="{{ route('app::local.rules') }}">Local Rules</a>.</label>
                        </div>
                    </div>
                    <!-- Member 2 Info -->
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m12 l12 center">
                            ...
                            <label for="mem3-agreement">I have read and accept <a href="{{ route('app::general.rules') }}">Regional Rules</a> and <a href="{{ route('app::local.rules') }}">Local Rules</a>.</label>
                        </div>
                    </div>
                    <!-- Member 3 Info -->
