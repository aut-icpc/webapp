...
<label for="17">2017</label>
    ...
    <a href="{{route('app::gallery.teams2017')}}" style="font-size: 20px; color: #0D47A1"; >Teams    </a>
,
    <a href="{{route('app::gallery.others2017')}}" style="font-size: 20px ; color: #0D47A1">    Others</a>
